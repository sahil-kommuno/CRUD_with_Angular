...
const {jwtAuthMiddleware} =require("../Middleware/commonMiddleware/Authentication.JWT")
...
router.delete('/deletedata/:id', loggerDetail,jwtAuthMiddleware, userFormData.deletedata);
router.put(
  '/updatedata/:id',
  upload.single('image'),
